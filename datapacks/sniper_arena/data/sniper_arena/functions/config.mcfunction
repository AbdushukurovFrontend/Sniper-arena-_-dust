...
# Har bir kill uchun alohida qurol bor: guns/level_1 ... guns/level_5
scoreboard players set #kills_to_win sa.cfg 5
...
# 0 = vaqt limiti yo'q
scoreboard players set #time_limit sa.cfg 600
