...
tellraw @s [{"text":"[Sniper Arena] ","color":"gold","bold":true},{"text":"Holat: ","color":"gray","bold":false},{"score":{"name":"#state","objective":"sa.var"},"color":"yellow","bold":false},{"text":" (0 kutish, 1 sanoq, 4 arena tanlash, 2 o'yin, 3 g'olib)","color":"gray","bold":false},{"text":"  |  O'yinda: ","color":"gray","bold":false},{"score":{"name":"#alive","objective":"sa.var"},"color":"yellow","bold":false},{"text":"  |  Spawnlar: ","color":"gray","bold":false},{"score":{"name":"#tmp","objective":"sa.var"},"color":"yellow","bold":false}]
...
execute if score #mod sa.var matches 1 run tellraw @s {"text":"Mod: bor. Arenalar ro'yxati: /sa arena list","color":"green","clickEvent":{"action":"suggest_command","value":"/sa arena list"}}
execute unless score #mod sa.var matches 1 run tellraw @s {"text":"Mod: topilmadi — eski usul (bitta arena, spawn markerlari)","color":"red"}
